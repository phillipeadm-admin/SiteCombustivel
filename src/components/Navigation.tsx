...
import { Fuel, LayoutDashboard, Settings, FileText, TrendingUp } from "lucide-react";
...
export function Navigation() {
    ...
    const links = [
        ...
        { href: "/dashboard", label: "Dashboard do Mês", icon: LayoutDashboard },
        { href: "/dashboard-trimestral", label: "Dashboard Trimestral", icon: TrendingUp },
