        ...
        <div className="space-y-6 relative">
                                    ...
                                    <td className="py-4 text-center">
                                        {row.imagemUrl ? (
                                            <div className="relative group/img inline-block cursor-pointer">
                                                ...
                                                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover/img:block z-[60] pointer-events-none">
                                                    <div className="bg-white p-2 rounded-xl shadow-2xl border border-slate-200">
                                                        {/* eslint-disable-next-line @next/next/no-img-element */}
                                                        <img src={row.imagemUrl} alt="Comprovante" className="max-w-[250px] max-h-[250px] object-cover rounded-lg" />
                                                    </div>
                                                </div>
                                            </div>
                                        ) : (
            ...
            {selectedImage && (
                ...
                >
                    ...
                    >
                        <button
                            className="absolute -top-12 right-0 md:-right-12 bg-white/10 hover:bg-white/30 text-white rounded-full p-2 backdrop-blur-md transition-colors"
                            onClick={() => setSelectedImage(null)}
                        >
                            <X className="w-8 h-8" />
                        </button>
